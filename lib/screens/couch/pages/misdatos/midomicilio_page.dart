...
class Midomicilio extends StatefulWidget {
  @override
  _MidomicilioState createState() => _MidomicilioState();
}

class _MidomicilioState extends State<Midomicilio> {
  ...
  final TextEditingController _asentamientoController = TextEditingController(text: '');
